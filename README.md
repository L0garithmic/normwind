...
- **Canonical snapshot regenerated** — the bundled reference now contains 12,438 replacements generated by Tailwind 4.3.3, including its new case-insensitive arbitrary hex-color canonicalization (`bg-[#FFF]` → `bg-white`).
