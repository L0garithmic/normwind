...
export const AllRadius = () => (
    <div className="rounded-t-md rounded-b-md">all corners</div>
);

export const AllSideRadius = () => (
    <div className="rounded-xl">all sides</div>
);

export const BorderSides = () => (
    <div className="border">border box</div>
);

export const HoverCorners = () => (
    <div className="hover:rounded-t-lg">hover corners</div>
);
